...
export const metadata = {
  title: 'Nhà đất bán | BĐS Vietnam',
  description: 'Danh sách bất động sản đang rao bán trên toàn quốc.',
};
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Khám phá hàng trăm bất động sản đang rao bán — nhà phố, căn hộ, biệt thự — trên khắp Việt Nam.
        </p>
      </div>
      ...
      <div className="mb-6">
        <h2 className="text-2xl font-semibold text-gray-900">Bất động sản đang bán</h2>
        <p className="text-gray-600 mt-1">
          Hiển thị {paginated.data.length} trong tổng số {paginated.total} bất động sản
        </p>
      </div>
